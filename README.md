...
| 출처 | 플러그인 |
|------|----------|
| Freegrow 자체 개발 | `embedded-development`, `flutter-development` |
...
| 9 | [frontend-mobile-development](#9-frontend-mobile-development) | React, Next.js, React Native | 2 | 4 | 1 |
| 10 | [git-pr-workflows](#10-git-pr-workflows) | Git 워크플로우, PR 관리 | 1 | - | 3 |
| 11 | [multi-platform-apps](#11-multi-platform-apps) | iOS, React Native 크로스플랫폼 | 5 | - | 1 |
